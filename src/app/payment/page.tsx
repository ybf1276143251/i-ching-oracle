      ...
      <div className="max-w-lg mx-auto px-6">
        <div className="glass glass-glow p-8 md:p-10 text-center">
          ...
          <div className="bg-[rgba(255,255,255,0.03)] rounded-xl p-5 mb-6 text-left text-sm space-y-3">
            <h3 className="font-semibold text-[var(--gold)] text-center mb-3">📋 After Payment — 付款后</h3>
            <div className="space-y-2 text-[var(--text-secondary)]">
              <p>1. Screenshot your payment confirmation / 截图支付凭证</p>
              <p>2. Include your registered email / 附上你的注册邮箱</p>
              <p>3. Send via any channel below / 通过以下任一方式发送</p>
            </div>
          </div>
          ...
          <div className="space-y-3 mb-8">
            <a
              href="https://twitter.com/Fassfannqbjj"
              target="_blank"
          ...
          <p className="text-xs text-[var(--text-muted)] mb-6">
            Activation within 24 hours after verification · 审核通过后24小时内开通
          </p>
